...
keybinds clear-defaults=true {
    ...
    tmux {
        ...
        // tmux muscle-memory: copy/search
        bind "[" { SwitchToMode "scroll"; }
        bind "/" { SwitchToMode "entersearch"; SearchInput 0; }
        bind "E" { EditScrollback; SwitchToMode "locked"; }

        // tmux muscle-memory: panes
        ...
        bind "0" { GoToTab 1; SwitchToMode "locked"; }
        bind "1" { GoToTab 1; SwitchToMode "locked"; }
        bind "2" { GoToTab 2; SwitchToMode "locked"; }
        bind "3" { GoToTab 3; SwitchToMode "locked"; }
        bind "4" { GoToTab 4; SwitchToMode "locked"; }
        ...
        bind "8" { GoToTab 8; SwitchToMode "locked"; }
        bind "9" { GoToTab 9; SwitchToMode "locked"; }
        bind "i" { MoveTab "left"; SwitchToMode "locked"; }
        bind "u" { MoveTab "right"; SwitchToMode "locked"; }
        ...
        // Zellij equivalents for existing custom behavior
        bind "S" { ToggleActiveSyncTab; SwitchToMode "locked"; }
        bind "+" { Resize "Increase"; SwitchToMode "locked"; }
        bind "=" { Resize "Increase"; SwitchToMode "locked"; }
        bind "-" { Resize "Decrease"; SwitchToMode "locked"; }

        // Ctrl+a access to full Zellij modes without using Ctrl+g or Alt
        ...
        bind "?" {
            ...
            "prefix"                "ctrl + a"
            "literal ctrl+a"        "ctrl + a + ctrl + a"
            "sessions"              "ctrl + a + s/w"
            "detach"                "ctrl + a + D"
            "new tab/window"        "ctrl + a + c"
            "rename tab/window"     "ctrl + a + ,"
            "close tab/window"      "ctrl + a + &"
            "previous/next tab"     "ctrl + a + p/n"
            "go to tab"             "ctrl + a + 1..9"
            "split right"           "ctrl + a + v or %"
            "split down"            "ctrl + a + d or \""
            "focus pane"            "ctrl + a + h/j/k/l or arrows"
            "next/previous pane"    "ctrl + a + o / ;"
            "close pane"            "ctrl + a + x"
            "fullscreen"            "ctrl + a + z"
            "floating/embed"        "ctrl + a + f/e"
            "scroll/copy"           "ctrl + a + ["
            "search"                "ctrl + a + /"
            "sync tab"              "ctrl + a + S"
            "resize"                "ctrl + a + +/-/= or R then h/j/k/l"
            "zellij modes"          "ctrl + a + P/T/R/M/O"
            floating true
            }
            SwitchToMode "locked"
        }
        bind "y" {
            ...
            "help"                  "ctrl + a + ?"
            "sessions"              "ctrl + a + s/w"
            "split right/down"      "ctrl + a + v/d or %/\""
            "tabs"                  "ctrl + a + c, p, n, 1..9, &, ,"
            "panes"                 "ctrl + a + h/j/k/l, o, ;, x, z"
            "zellij modes"          "ctrl + a + P/T/R/M/O"
            floating true
            }
            SwitchToMode "locked"
