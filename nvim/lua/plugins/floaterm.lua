return {
  ...
  keys = {
    ...
    -- New terminals
    { "<M-j>", "<cmd>FloatermNew<cr>", mode = { "n", "t" }, desc = "New Terminal" },

    -- Navigation
    { "<M-h>", "<cmd>FloatermPrev<cr>", mode = "t", desc = "Prev Terminal" },
    { "<M-l>", "<cmd>FloatermNext<cr>", mode = { "t" }, desc = "Next Terminal" },
    {
      "<M-k>",
      "<cmd>FloatermKill<cr><cmd>FloatermPrev<cr>",
      mode = "t",
      desc = "Kill Term and Go to Previous",
    },
    ...
    { "<M-f>", "<cmd>FloatermToggle<cr>", mode = { "t", "n" }, desc = "Toggle Terminal" },
  ...
  config = function()
    ...
    vim.api.nvim_set_hl(0, "Floaterm", { bg = nil }) -- Custom background
