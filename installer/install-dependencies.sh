...
# ----------------------------------------------------------------------------
# Instalar Node.js LTS (última versión estable) usando NodeSource
info "Instalando Node.js LTS (última versión estable) desde NodeSource..."
curl -fsSL https://deb.nodesource.com/setup_lts.x | bash -
apt-get install -y nodejs
success "Node.js LTS instalado correctamente."
# ----------------------------------------------------------------------------
