...
func GetNvimKeymaps() []KeymapCategory {
	return []KeymapCategory{
		...
		},
		{
			...
			Keymaps: []Keymap{
				{Keys: "-", Description: "Open Oil (parent directory)", Mode: "n"},
				{Keys: "<leader>E", Description: "Open Oil (floating window)", Mode: "n"},
		...
		},
		{
			...
			Keymaps: []Keymap{
				...
				{Keys: "<leader>go", Description: "Open file in git repo (browser)", Mode: "n"},
		...
		{
			Name:        "AI Assistants (Avante/Copilot)",
			Description: "AI-powered coding assistance",
			Keymaps: []Keymap{
				{Keys: "<leader>aa", Description: "Toggle Avante (AI sidebar)", Mode: "n"},
				{Keys: "<leader>ae", Description: "Edit with AI", Mode: "n,v"},
				{Keys: "<leader>ar", Description: "Refresh Avante", Mode: "n"},
				{Keys: "<leader>af", Description: "Focus Avante", Mode: "n"},
				{Keys: "<leader>at", Description: "Toggle Avante", Mode: "n"},
				...
				{Keys: "<leader>ap", Description: "Copilot Panel", Mode: "n"},
			},
		},
		{
			Name:        "Obsidian (Notes)",
			...
			Keymaps: []Keymap{
				{Keys: "<leader>on", Description: "New note", Mode: "n"},
				{Keys: "<leader>oo", Description: "Open note (search)", Mode: "n"},
				{Keys: "<leader>os", Description: "Search in notes", Mode: "n"},
				{Keys: "<leader>ot", Description: "Open today's daily note", Mode: "n"},
				{Keys: "<leader>ob", Description: "Show backlinks", Mode: "n"},
				{Keys: "<leader>ol", Description: "Insert link", Mode: "n"},
				{Keys: "gf", Description: "Follow link (in note buffer)", Mode: "n"},
				{Keys: "<leader>ch", Description: "Toggle checkbox", Mode: "n"},
				{Keys: "<CR>", Description: "Smart action (follow/toggle)", Mode: "n"},
			},
		},
		{
			Name:        "Buffers & Tabs",
		...
		},
		{
			...
			Keymaps: []Keymap{
				...
				{Keys: "<leader>du", Description: "Toggle DAP UI", Mode: "n"},
		...
		},
		{
			...
			Keymaps: []Keymap{
				...
				{Keys: "<A-j>", Description: "Move Line Down", Mode: "n,i,v"},
				{Keys: "<A-k>", Description: "Move Line Up", Mode: "n,i,v"},
			},
		},
	}
}
