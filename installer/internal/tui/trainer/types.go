...
func GetAllModules() []ModuleInfo {
	return []ModuleInfo{
		...
		},
		{
			...
			Name:        "Text Objects",
			Icon:        "🎯",
			Description: "ciw, caw, ci\", ca\", ci{, ca{, di*, yi*, vi*",
		...
		},
		{
			...
			Name:        "Substitution",
			Icon:        "🔄",
			Description: ":s, :%s, ranges, flags (g, c, i, I)",
		...
		},
		{
			...
			Name:        "Regex & Vimgrep",
			Icon:        "🔍",
			Description: "/, ?, \\v, :vimgrep, quickfix",
